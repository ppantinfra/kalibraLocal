...
import { useGradientProgressBarStyles } from './GradientProgressBarStyles';
...
const GradientProgressBar = ({
  ...
  const classes = useGradientProgressBarStyles();
  ...
  return (
    <React.Fragment>
      <Box className={`${classes.graphWrapper} graphWrapper_clientView graphWrapper_overview`}>
        <Box style={divStyle} className={`${classes.mainBox} mainBox_overview`}>
            ...
            (
              ...
              return (
                <Box
                  ...
                  title={item.label}
                  className={`${classes.progressVisualPart} progressVisualPart_overview `}
                ></Box>
              );
            }
          )}
